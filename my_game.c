...
int main (int argc, char **argv) {
    ...
    b.image = IMG_Load(COLLECTIBLE_BALL_FILENAME);
    b.type = Green;
    b.place.x = 50;
    b.place.y = 20;
    b.place.w = b.place.h = 64;
    ...
    while(!quit) {
     ...
     SDL_BlitSurface(b.image, NULL, screen, &b.place);

     SDL_Flip(screen);

     SDL_UpdateRects(screen, 1, &b.place);
